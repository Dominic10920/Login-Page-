...
const dashboardURL = "https://sites.google.com/view/edutuklas/home"; // Replace with your actual page URL
        ...
        fetch(scriptURL, {
            ...
            .then(result => {
                if (result === "Success") {
                    ...
                    newButton.innerText = 'Go to Dashboard';
                    newButton.className = 'dynamic-button';
                    newButton.addEventListener('click', function () {
                        // Redirect directly to the configured dashboard URL
                        window.location.href = dashboardURL; // Redirect to the dashboard page
                    });
